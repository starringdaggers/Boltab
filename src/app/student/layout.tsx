...
const NAV_ITEMS = [
  ...
  { href: "/student/attendance", label: "Attendance", icon: "attendance" as const },
  { href: "/student/timetable", label: "Timetable", icon: "timetable" as const },
  { href: "/student/fees", label: "School Fees", icon: "fees" as const },
